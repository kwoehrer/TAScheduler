...
'''
As an Instructor, I want to be able to navigate to the Instructor Send Notifications Page
----------------------------------------------------
Scenario: Navigate to the Send Notifications Search Page
GIVEN: The user is an Instructor and is logged in and at the Send Notifications Page
...
GIVEN: The user is an Instructor and is logged in and at the Admin home page view

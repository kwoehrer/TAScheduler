...
class AbstractCourseFactory(ABC):
    @abstractmethod
    def createCourse(self, creator: AbstractUser, newAccountAttrbitutes: []):
        pass

    @abstractmethod
    def deleteCourse(self, deletor: AbstractUser, newAccountAttrbitutes: []):
        pass


class ConcreteCourseFactory(AbstractCourseFactory):
    def createCourse(self, creator: AbstractUser, new_course_attributes: []):
    ...
    def deleteCourse(self, deletor: AbstractUser, delete_course: AbstractCourse):
